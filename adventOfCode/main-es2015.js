...
let ProblemsListComponent = class ProblemsListComponent {
    constructor(problemProvider, problemResolverFactory) {
    ...
    GetProblemResolver(id) {
        return this.problemResolverFactory.GetProblemResolver(id);
    }
};
ProblemsListComponent.ctorParameters = () => [
...
let ProblemProviderService = class ProblemProviderService {
    constructor() {
        this.PROBLEMS = [
            {
...
let Day1ResolverService = class Day1ResolverService {
    ngOnInit() {
...
let Day2ResolverService = class Day2ResolverService {
    ngOnInit() {
...
let ProblemResolverFactoryService = class ProblemResolverFactoryService {
    GetProblemResolver(problemId) {
        switch (problemId) {
            case 0:
